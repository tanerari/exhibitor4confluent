...
{
    var newConfig = {};
    newConfig.confluentInstallDirectory = $('#config-confluent-install-dir').val();
...
function ableConfig(enable)
{
    ...
    $('#config-confluent-install-dir').prop('disabled', !enable);
...
function updateConfig()
{
    ...
    $('#config-confluent-install-dir').val(systemConfig.confluentInstallDirectory);
...
function checkConfigConfirmation()
{
    ...
    var     hasEnsembleLevelChange =
        (newConfig.confluentInstallDirectory != systemConfig.confluentInstallDirectory)
